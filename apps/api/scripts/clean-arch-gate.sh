...
npx vitest run src/contracts/contract-freeze.test.ts src/app.test.ts src/docs/openapi.test.ts src/errors/errors.test.ts src/domain/shared/types.test.ts src/domain/shared/ports.test.ts src/domain/shared/error-catalog.test.ts src/domain/user/user.test.ts src/domain/product/product.test.ts src/composition-root.test.ts src/infrastructure/persistence/error-map.test.ts src/application/shared/unit-of-work.test.ts src/config/db.test.ts
