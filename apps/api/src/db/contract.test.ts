...
describePg("migrations", () => {
  it("is idempotent: re-applying schema + seed + migrations keeps 26 tables and does not duplicate seed rows", async () => {
    ...
    // + services from 0007_services.sql
    // + stock_lots from 0006-stock-lots.sql.
