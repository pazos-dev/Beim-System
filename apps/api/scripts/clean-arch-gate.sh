...
npx vitest run src/contracts/contract-freeze.test.ts src/app.test.ts src/docs/openapi.test.ts src/errors/errors.test.ts src/domain/shared/types.test.ts src/domain/shared/ports.test.ts src/domain/shared/error-catalog.test.ts src/domain/user/user.test.ts src/domain/product/product.test.ts src/domain/product/stock-lot.test.ts src/domain/service/service.test.ts src/domain/venta/venta.test.ts src/domain/pago/pago.test.ts src/domain/receipt/receipt.test.ts src/domain/cash-session/cash-session.test.ts src/domain/stock-journal/stock-journal.test.ts src/domain/settings/settings.test.ts src/application/auth/handlers.test.ts src/application/catalog/product-handlers.test.ts src/application/catalog/service-handlers.test.ts src/composition-root.test.ts src/infrastructure/persistence/error-map.test.ts src/infrastructure/persistence/pg-user-session.test.ts src/infrastructure/persistence/pg-user-session.pg.test.ts src/infrastructure/persistence/pg-product-lots.test.ts src/infrastructure/persistence/pg-product-lots.pg.test.ts src/infrastructure/persistence/pg-service.test.ts src/infrastructure/persistence/pg-service.pg.test.ts src/infrastructure/errors/toAppError.test.ts src/infrastructure/db/pool.test.ts src/infrastructure/clock/system-clock.test.ts src/infrastructure/uuid/system-uuid.test.ts src/application/shared/unit-of-work.test.ts src/application/sales-batch/sales-batch.test.ts src/application/receipts/receipts.test.ts src/application/payments/payments.test.ts src/application/cash/cash.test.ts src/application/orders/orders.test.ts src/application/creates/creates.test.ts src/application/uploads/uploads.test.ts src/application/ticket/ticket.test.ts src/application/queries/queries.test.ts src/application/queries/queries-passthrough.test.ts src/config/db.test.ts
